...
<body>
	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
		...
		if (!empty($_SESSION['news_title_1'])) {
			print '<p><a href="index.php?menu=2&action=1">' . htmlspecialchars($_SESSION['news_title_1']) . '</a></p>';
		}
		if (!empty($_SESSION['news_title_2'])) {
			print '<p><a href="index.php?menu=2&action=2">' . htmlspecialchars($_SESSION['news_title_2']) . '</a></p>';
		}
		if (!empty($_SESSION['news_title_3'])) {
			print '<p><a href="index.php?menu=2&action=3">' . htmlspecialchars($_SESSION['news_title_3']) . '</a></p>';
		}
